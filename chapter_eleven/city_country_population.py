"""
 ...
 Chile – population 5000000. Run test _cities.py again. Make sure test_city_country() fails this time.
...
def city_country_population(city_name,country_name,population=''):
    if population:
        return str(city_name.title() + ', ' + country_name.title() + ' - population ' + population)
    else:
        return str(city_name.title() + ', ' + country_name.title())
